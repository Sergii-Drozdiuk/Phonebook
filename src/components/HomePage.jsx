...
export const HomePage = () => {
  ...
  return (
    <div className="flex min-h-[calc(100vh-112px)] flex-col justify-between bg-[url('/Phonebook/assets/Phone_with_phonebook.png')] bg-contain bg-center bg-no-repeat p-4">
      <div>
